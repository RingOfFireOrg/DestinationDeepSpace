...
public class TankDrive extends DifferentialDrive {
	...
	TankDrive() {
		super(new SpeedControllerGroup(new WPI_VictorSPX(RobotMap.MOTOR_FRONT_LEFT), new WPI_TalonSRX(RobotMap.MOTOR_BACK_LEFT)),
				new SpeedControllerGroup(new WPI_VictorSPX(RobotMap.MOTOR_FRONT_RIGHT), new WPI_TalonSRX(RobotMap.MOTOR_BACK_RIGHT)));
